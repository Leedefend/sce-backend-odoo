...
_CAPABILITIES: list[dict[str, Any]] = [
    ...
    _cap("project.plan_bootstrap.enter", "计划编排入口（预留）", "预留下一场景 project.plan_bootstrap 入口", "project_management", "project.dashboard", required_roles=["pm", "executive"], status="planned"),
