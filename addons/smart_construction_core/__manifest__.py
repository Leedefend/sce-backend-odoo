...
# pyright: reportUnusedExpression=false
{
    ...
    'data': [
        ...
        'views/support/legacy_enterprise_business_fact_views.xml',
        ...
        'views/support/legacy_direct_acceptance_views.xml',
        'views/support/legacy_engineering_progress_receipt_views.xml',
        'views/support/legacy_fuel_card_views.xml',
        ...
        'views/projection/invoice_analysis_summary_views.xml',
        'views/projection/invoice_cost_progress_summary_views.xml',
        'views/projection/project_operation_summary_views.xml',
        'views/projection/tender_guarantee_summary_views.xml',
        ...
        'views/support/scbs_fact_staging_views.xml',
        'views/support/scbs_material_map_views.xml',
