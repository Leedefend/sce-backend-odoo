...
class TestRecordRuleBehaviorGate(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.payment_req_user = Env["payment.request"].create(
            {
        ...
        cls.settlement_read = Env["sc.settlement.order"].create(
            {
        ...
        cls.settlement_user = Env["sc.settlement.order"].create(
            {
