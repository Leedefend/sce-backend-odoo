...
ACL_EXPECTATIONS = [
    ...
    {"role": "project_read", "model": "tender.bid", "rights": {"read": True, "create": False, "write": False, "unlink": False}},
    {"role": "project_manager", "model": "tender.bid", "rights": {"read": True, "create": True, "write": True, "unlink": True}},
