    ...
    def handle(self, payload=None, ctx=None):
        ...
        return {
            ...
            "data": {
                ...
                "reason_code": "EXECUTION_ENTRY_RESERVED",
                "message": "Phase 13-B/B1 仅交付 execution.enter 调度入口，执行场景本体待后续批次展开。",
                "suggested_action": {
                    "key": "return_plan_bootstrap",
                    "intent": "project.plan_bootstrap.enter",
                    "params": {"project_id": project_id},
                    "reason_code": "EXECUTION_SCENE_NOT_DELIVERED_YET",
                },
            },
            "meta": {
                "intent": self.INTENT_TYPE,
