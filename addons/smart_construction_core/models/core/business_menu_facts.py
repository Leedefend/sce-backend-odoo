    ...
    def _target_tree(self):
        ...
        return {
            "智慧大屏": {
                ...
                "资金驾驶舱": f("sc.dashboard.cockpit.fact", "fund_cockpit"),
                "成本驾驶舱": f("sc.dashboard.cockpit.fact", "cost_cockpit"),
            },
            "工作台": {
                "我的待办": f("sc.workbench.item", "my_todo"),
                "我的项目": "smart_construction_core.action_sc_project_my_list",
                "我的审批": f("sc.workbench.item", "my_approval"),
                "最近访问": f("sc.workbench.item", "recent_visit"),
            },
            "项目中心": {
                "项目管理": {
                ...
                "项目预算": {
                    ...
                    "物资预算": f("sc.project.budget.fact", "material_budget"),
                    "人工预算": f("sc.project.budget.fact", "labor_budget"),
                    "机械预算": f("sc.project.budget.fact", "machine_budget"),
                    "分包预算": f("sc.project.budget.fact", "subcontract_budget"),
                    "措施费": f("sc.project.budget.fact", "measure_budget"),
                    "税费": f("sc.project.budget.fact", "tax_budget"),
                },
                "施工资料": {
                    "现场资料": "smart_construction_core.action_sc_project_document",
                    "安全资料": f("sc.project.document.fact", "safety_document"),
                    "质量资料": f("sc.project.document.fact", "quality_document"),
                    "自检资料": f("sc.project.document.fact", "self_inspection_document"),
                    "归档备案": f("sc.project.document.fact", "archive_document"),
                },
            },
            "合同中心": {
                "收入合同": {
            ...
            "施工管理": {
                ...
                "质量检查": f("sc.construction.inspection", "quality_check"),
                "质量整改": f("sc.construction.inspection", "quality_rectification"),
                "安全检查": f("sc.construction.inspection", "safety_check"),
                "安全整改": f("sc.construction.inspection", "safety_rectification"),
                "施工日志": "smart_construction_core.action_sc_construction_diary",
                "日报表": f("sc.construction.report", "daily_report"),
                "周报表": f("sc.construction.report", "weekly_report"),
                "月报表": f("sc.construction.report", "monthly_report"),
            },
            "成本中心": {
                ...
                "成本汇总": f("sc.analysis.report.fact", "project_cost_statistics"),
                "经营利润": f("sc.analysis.report.fact", "project_profit_statistics"),
            },
            "财务中心": {
                "收付款管理": {
                ...
                "资金计划": {
                    ...
                    "资金计划汇总": f("sc.fund.operation", "funding_plan_summary"),
                },
                "费用报销": {
                    "备用金": f("sc.finance.expense.document", "advance_fund"),
                    "借款单": f("sc.finance.expense.document", "borrowing_form"),
                    "还款单": f("sc.finance.expense.document", "repayment_form"),
                    "费用报销单": "smart_construction_core.action_sc_expense_claim_expense",
                    "项目费用报销单": f("sc.finance.expense.document", "project_expense_claim"),
                },
                "资金账户": {
                    ...
                    "资金划拨": f("sc.fund.operation", "fund_transfer_out"),
                    "资金调拨": f("sc.fund.operation", "fund_transfer_between"),
                    "余额调整": f("sc.fund.operation", "balance_adjustment"),
                    "资金日报表": f("sc.fund.operation", "fund_daily_report"),
                },
                "保证金管理": {
            ...
            "统计分析": {
                "经营分析": {
                    ...
                    "项目利润统计": f("sc.analysis.report.fact", "project_profit_statistics"),
                    "项目成本汇总": f("sc.analysis.report.fact", "project_cost_statistics"),
                ...
                "财务分析": {
                    ...
                    "资金计划统计表": f("sc.analysis.report.fact", "funding_plan_statistics"),
                },
                "物资分析": {
                    "入库统计": f("sc.analysis.report.fact", "inbound_statistics"),
                    "出库统计": f("sc.analysis.report.fact", "outbound_statistics"),
                    "退货统计": f("sc.analysis.report.fact", "return_statistics"),
                    "库存统计表": f("sc.analysis.report.fact", "inventory_statistics"),
                    "材料结算明细表": f("sc.analysis.report.fact", "material_settlement_detail"),
                },
                "人资分析": {
                    "薪资统计": f("sc.analysis.report.fact", "salary_statistics"),
                    "劳务统计": f("sc.analysis.report.fact", "labor_statistics"),
                    "考勤统计汇总表": f("sc.analysis.report.fact", "attendance_statistics"),
                },
                "投标分析": {
                    "投标明细表": f("sc.analysis.report.fact", "tender_detail_report"),
                    "投标统计表": f("sc.analysis.report.fact", "tender_statistics_report"),
                },
            },
            "基础设置": {
