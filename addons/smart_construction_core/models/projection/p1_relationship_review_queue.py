...
class ScP1RelationshipReviewQueue(models.Model):
    ...
    def init(self):
        ...
        specs = [
            ...
            ("payment_expense", "sc.expense.claim", "sc_expense_claim", "res.partner", "partner_id", "partner", "legacy_visible_supplier_name", "manual_review_candidate"),
            ("payment_expense", "sc.expense.claim", "sc_expense_claim", "payment.request", "payment_request_id", "payment_request", "legacy_visible_document_no", "manual_review_candidate"),
            ("payment_expense", "sc.payment.execution", "sc_payment_execution", "res.partner", "partner_id", "partner", "legacy_visible_supplier_name", "manual_review_candidate"),
            ("payment_expense", "sc.payment.execution", "sc_payment_execution", "payment.request", "payment_request_id", "payment_request", "legacy_visible_request_no", "manual_review_candidate"),
            ("payment_expense", "payment.request", "payment_request", "construction.contract", "contract_id", "contract", "legacy_visible_contract_no", "insufficient_evidence"),
            ...
            ("tax_invoice", "sc.invoice.registration", "sc_invoice_registration", "construction.contract", "contract_id", "contract", "legacy_visible_contract_no", "insufficient_evidence"),
            ("account_interfund", "sc.fund.account.operation", "sc_fund_account_operation", "sc.fund.account", "source_account_id", "fund_account", "legacy_visible_account_name", "manual_review_candidate"),
            ("account_interfund", "sc.fund.account.operation", "sc_fund_account_operation", "sc.fund.account", "target_account_id", "fund_account", "legacy_visible_counterparty_account_name", "manual_review_candidate"),
