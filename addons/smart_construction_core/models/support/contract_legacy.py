...
class ConstructionContractLegacy(models.Model):
    ...
    legacy_visible_document_state = fields.Char(string="单据状态", readonly=True)
    legacy_visible_document_no = fields.Char(string="单据编号", readonly=True)
    legacy_visible_contract_date = fields.Date(string="合同订立日期", readonly=True)
    legacy_visible_archived = fields.Char(string="原件是否归档", readonly=True)
    legacy_visible_counterparty = fields.Char(string="发包人", readonly=True)
    legacy_visible_contractor = fields.Char(string="承包人", readonly=True)
    legacy_visible_project_name = fields.Char(string="项目名称", readonly=True)
    legacy_visible_title = fields.Char(string="合同标题", readonly=True)
    legacy_visible_category = fields.Char(string="工程类别", readonly=True)
    legacy_visible_contract_no = fields.Char(string="合同编号", readonly=True)
    legacy_visible_amount = fields.Char(string="合同金额", readonly=True)
    legacy_visible_settlement_amount = fields.Char(string="结算金额", readonly=True)
    legacy_visible_invoice_amount = fields.Char(string="累计开票", readonly=True)
    legacy_visible_invoice_unreceived_amount = fields.Char(string="开票未收款", readonly=True)
    legacy_visible_received_amount = fields.Char(string="累计收款", readonly=True)
    legacy_visible_unreceived_amount = fields.Char(string="未收款", readonly=True)
    legacy_visible_unreceived_rate = fields.Char(string="未收款比例", readonly=True)
    legacy_visible_affiliated_person = fields.Char(string="挂靠人", readonly=True)
    legacy_visible_engineering_address = fields.Char(string="工程地址", readonly=True)
    legacy_visible_engineering_content = fields.Text(string="合同内容", readonly=True)
    legacy_visible_contract_duration_days = fields.Char(string="合同工期天数", readonly=True)
    legacy_visible_creator_name = fields.Char(string="录入人", readonly=True)
    legacy_visible_created_time = fields.Datetime(string="录入时间", readonly=True)
    legacy_visible_attachment = fields.Text(string="附件", readonly=True)
