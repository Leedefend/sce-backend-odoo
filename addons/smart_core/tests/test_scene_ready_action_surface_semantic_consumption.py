...
class TestSceneReadyActionSurfaceSemanticConsumption(unittest.TestCase):
    def test_builder_groups_actions_by_tree_semantics(self):
            ...
            scenes=[
                {
                    ...
                    "actions": [{"key": "open"}, {"key": "bulk_approve"}, {"key": "export"}],
                    "ui_base_contract": {
        ...
        action_surface = row.get("action_surface") or {}
