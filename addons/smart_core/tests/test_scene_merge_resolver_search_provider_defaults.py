...
def _load_module():
    spec = importlib.util.spec_from_file_location("scene_merge_resolver_provider_defaults_under_test", MODULE_PATH)
...
class TestSceneMergeResolverSearchProviderDefaults(unittest.TestCase):
    def test_provider_conflict_tracks_default_sort_override(self):
        compiled = {
            "search_surface": {
