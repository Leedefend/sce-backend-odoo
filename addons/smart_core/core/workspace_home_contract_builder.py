...
from .workspace_home_semantic_orchestration_bridge import apply_workspace_home_semantic_orchestration_bridge
...
def _build_metric_sets(ready_count: int, locked_count: int, preview_count: int, scene_count: int, today_action_count: int, risk_action_count: int) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    return build_metric_sets(
        ...
        tone_from_level_resolver=_tone_from_level,
    )
...
def build_workspace_home_contract(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    result = apply_workspace_home_parser_semantic_bridge(result, data)
    return apply_workspace_home_semantic_orchestration_bridge(result)
