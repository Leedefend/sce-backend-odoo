...
from ..builders.catalog_builder import build_app_open_contract
from ..services.catalog_service import AppCatalogServiceV2


class AppOpenHandlerV2(BaseIntentHandlerV2):
    ...
    def execute(self, payload: Dict[str, Any], context: HandlerContextV2) -> Dict[str, Any]:
        ...
        return self._service.build_app_open(app_key)

    def build(self, result: Dict[str, Any]) -> Dict[str, Any]:
        return build_app_open_contract(result)
