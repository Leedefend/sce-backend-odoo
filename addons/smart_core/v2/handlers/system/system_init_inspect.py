...
from ...builders.system_builder import build_system_init_inspect_contract
from ...services.system_service import SystemService
from ..base import BaseIntentHandlerV2, HandlerContextV2


class SystemInitInspectHandlerV2(BaseIntentHandlerV2):
    ...
    def execute(self, payload: Dict[str, Any], context: HandlerContextV2) -> Dict[str, Any]:
        ...
        return self._service.build_system_init_inspect(payload or {}, ctx)

    def build(self, result: Dict[str, Any]) -> Dict[str, Any]:
        return build_system_init_inspect_contract(result)
