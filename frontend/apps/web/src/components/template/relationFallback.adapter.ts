...
export function createRelationFallbackAdapter(context: CreateRelationFallbackAdapterContext): RelationFallbackAdapter {
  return {
    ...
    canOpenRelationRecord: context.canOpenRelationRecord,
    relationRecordLabel: context.relationRecordLabel,
    openRelationRecord: context.openRelationRecord,
    relationCreateMode: context.relationCreateMode,
    relationCreateLabel: context.relationCreateLabel,
    relationInlineCreateLabel: context.relationInlineCreateLabel,
    canInlineCreateRelation: context.canInlineCreateRelation,
    openRelationCreate: context.openRelationCreate,
