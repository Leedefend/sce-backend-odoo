...
verify.seed.demo.isolation: guard.prod.forbid verify.scene.provider.guard verify.test_seed_dependency.guard
...
verify.contract.snapshot: guard.prod.forbid verify.scene.contract.shape
