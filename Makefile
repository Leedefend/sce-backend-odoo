...
verify.phase_next.evidence.bundle: guard.prod.forbid verify.role.capability_floor.prod_like verify.contract.assembler.semantic.smoke verify.runtime.surface.dashboard.report
