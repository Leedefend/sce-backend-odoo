...
prod.sim.formal.projections.refresh: guard.prod.forbid check-compose-project check-compose-env
	...
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.settlement_adjustment.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.expense_claim.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.treasury_reconciliation.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.receipt_income.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.payment_execution.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.invoice_registration.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.financing_loan.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.general_contract.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.construction_diary.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.material_category.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" fresh_db.material_catalog.projection.write
	@$(MAKE) MIGRATION_ARTIFACT_ROOT="$(FORMAL_PROJECTION_ARTIFACT_ROOT)" verify.prod.sim.formal.projections
...
history.formal_menu_model.convergence.probe: guard.prod.forbid check-compose-project check-compose-env
	@$(RUN_ENV) DB_NAME=$(DB_NAME) MIGRATION_ARTIFACT_ROOT="$(MIGRATION_ARTIFACT_ROOT)" bash scripts/ops/odoo_shell_exec.sh < scripts/verify/formal_menu_model_convergence_probe.py
...
verify.unified_page_contract.v2.status: guard.prod.forbid
	...
	@python3 scripts/verify/unified_page_contract_v2_status_guard.py --fixture docs/architecture/unified_page_contract_v2/fixtures/status_contract_source.json --snapshot docs/architecture/unified_page_contract_v2/snapshots/status_contract_snapshot_v1.json
...
verify.unified_page_contract.v2.runtime: guard.prod.forbid
	@python3 -m py_compile addons/smart_core/core/unified_page_contract_v2_runtime.py scripts/verify/unified_page_contract_v2_runtime_guard.py
...
.PHONY: verify.unified_page_contract.lite.api_onchange_interface verify.unified_page_contract.lite.api_onchange_intent.container verify.unified_page_contract.lite.startup_negative.container verify.unified_page_contract.lite.load_contract_negative.container verify.unified_page_contract.lite.load_contract_preview_interface verify.unified_page_contract.lite.load_contract_preview_intent.container verify.unified_page_contract.lite.load_contract_preview_matrix.container verify.unified_page_contract.lite.frontend_runtime_negative verify.unified_page_contract.lite.frontend_pilot_implementation verify.unified_page_contract.lite.frontend_pilot_browser.host verify.unified_page_contract.lite.api_onchange_live_scope.container verify.unified_page_contract.lite.load_contract_live_scope.container verify.unified_page_contract.lite.runtime_scope_closure verify.unified_page_contract.lite.phase1_closure verify.unified_page_contract.lite.phase2_candidate_plan verify.unified_page_contract.lite.phase2_load_contract_gate verify.unified_page_contract.lite.phase3_ui_contract_risk verify.unified_page_contract.lite.frontend_pilot_readiness verify.unified_page_contract.lite.contract_freeze_v2_0 verify.unified_page_contract.lite
