...
verify.contract.envelope: guard.prod.forbid verify.contract.mode.smoke verify.contract.api.mode.smoke verify.scene_capability.contract.guard
...
verify.backend.architecture.full: guard.prod.forbid verify.intent.router.purity verify.boundary.guard verify.contract.envelope verify.mode.filter verify.capability.schema verify.scene.schema verify.seed.demo.isolation verify.business.capability_baseline.guard verify.contract.snapshot verify.contract.governance.coverage verify.scene.hud.trace.smoke verify.scene.meta.trace.smoke
