...
verify.backend.architecture.full: guard.prod.forbid verify.intent.router.purity verify.boundary.guard verify.contract.envelope verify.mode.filter verify.capability.schema verify.role.capability_floor.guard verify.scene.schema verify.seed.demo.isolation verify.scene.catalog.runtime_alignment.guard verify.business.core_journey.guard verify.contract.snapshot verify.contract.governance.coverage verify.scene.hud.trace.smoke verify.scene.meta.trace.smoke
