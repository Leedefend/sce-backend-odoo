...
verify.unified_page_contract.lite.wx_mini_real_compile_pilot.host: verify.unified_page_contract.lite.wx_mini_compile_pilot.host
	@python3 scripts/verify/unified_page_contract_lite_wx_mini_real_compile_pilot_guard.py --report artifacts/backend/unified_page_contract_lite_wx_mini_real_compile_pilot.json
