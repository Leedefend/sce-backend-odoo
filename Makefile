...
.PHONY: verify.business.finance_document_tier_runtime_smoke verify.formal_business_backfill.audit verify.tender_optional_scope_metadata.probe verify.platform_company_access_kernel.probe
...
verify.platform_company_access_kernel.probe: check-compose-project check-compose-env
