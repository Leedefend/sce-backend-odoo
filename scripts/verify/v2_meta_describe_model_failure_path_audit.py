...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        payload={"model": ""},
        context={"user_id": 7, "company_id": 2, "trace_id": "meta-fail-schema-1626"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="meta.describe_model",
        payload={"model": "res.partner", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "meta-fail-handler-1626"},
    )
