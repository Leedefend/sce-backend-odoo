...
def run_audit() -> Dict[str, object]:
    ...
    compare = run_shadow_compare(
        ...
        params={"model": "res.partner", "view_type": "form"},
        context={"trace_id": "compare-ui-contract-1674", "user_id": 1, "company_id": 1},
        v1_result={"ok": True, "data": {"view": {}}, "meta": {"intent": "ui.contract"}},
    ...
    if str(compare.get("intent") or "") != "ui.contract":
