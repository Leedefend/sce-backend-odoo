...
def run_audit() -> Dict[str, object]:
    ...
    result = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "api-onchange-1643"},
    )
    ...
    if str(data.get("intent") or "") != "api.onchange":
        errors.append("intent_mismatch")
    if str(data.get("model") or "") != "res.partner":
        errors.append("model_mismatch")
    if str(data.get("field_name") or "") != "name":
        errors.append("field_name_mismatch")
