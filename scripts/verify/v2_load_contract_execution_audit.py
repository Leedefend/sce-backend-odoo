...
def run_audit() -> Dict[str, object]:
    ...
    result = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "load-contract-1667"},
    )
    ...
    if str(data.get("intent") or "") != "load_contract":
        errors.append("intent_mismatch")
    if str(data.get("model") or "") != "res.partner":
        errors.append("model_mismatch")
    if str(data.get("view_type") or "") != "form":
        errors.append("view_type_mismatch")
