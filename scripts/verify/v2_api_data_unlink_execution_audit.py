...
def run_audit() -> Dict[str, object]:
    ...
    result = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-unlink-1655"},
    )
    ...
    if str(data.get("intent") or "") != "api.data.unlink":
        errors.append("intent_mismatch")
    if str(data.get("model") or "") != "res.partner":
        errors.append("model_mismatch")
    if list(data.get("ids") or []) != [8, 9]:
        errors.append("ids_mismatch")
