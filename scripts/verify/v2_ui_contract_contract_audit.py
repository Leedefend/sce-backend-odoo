...
SNAPSHOT = ROOT / "artifacts" / "v2" / "ui_contract_contract_snapshot_v1.json"
...
def run_audit() -> Dict[str, object]:
    ...
    if snapshot.get("snapshot_id") != "ui_contract_contract_snapshot_v1":
    ...
    success = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "ui-contract-1632-pass"},
    )
    ...
    if str(meta.get("intent") or "") != "ui.contract":
    ...
    failure = dispatch_intent(
        intent="ui.contract",
        payload={"model": ""},
        context={"user_id": 17, "company_id": 5, "trace_id": "ui-contract-1632-fail"},
    )
