...
def run_audit() -> Dict[str, object]:
    ...
    result = dispatch_intent(
        ...
        payload={"model": "res.partner", "operations": [{"op": "read"}, {"op": "write"}]},
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-batch-1647"},
    )
