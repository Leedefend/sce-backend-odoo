...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "exec-btn-fail-schema-1635"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="execute_button",
        payload={"model": "res.partner", "record_id": 1, "button_name": "action_confirm", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "exec-btn-fail-handler-1635"},
    )
