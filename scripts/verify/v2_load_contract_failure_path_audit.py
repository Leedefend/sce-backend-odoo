...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "load-contract-fail-schema-1667"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="load_contract",
        payload={"model": "res.partner", "view_type": "form", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "load-contract-fail-handler-1667"},
    )
