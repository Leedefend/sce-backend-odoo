...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-create-fail-schema-1651"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="api.data.create",
        payload={"model": "res.partner", "values": {"name": "Demo"}, "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-create-fail-handler-1651"},
    )
