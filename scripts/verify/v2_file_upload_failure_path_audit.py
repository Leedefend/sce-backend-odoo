...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "file-upload-fail-schema-1659"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="file.upload",
        payload={"model": "res.partner", "res_id": 1, "data": "dGVzdA==", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "file-upload-fail-handler-1659"},
    )
