...
SNAPSHOT = ROOT / "artifacts" / "v2" / "api_data_batch_contract_snapshot_v1.json"
...
def run_audit() -> Dict[str, object]:
    ...
    if snapshot.get("snapshot_id") != "api_data_batch_contract_snapshot_v1":
    ...
    success = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-batch-contract-1649-pass"},
    )
    ...
    failure = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-batch-contract-1649-fail"},
    )
