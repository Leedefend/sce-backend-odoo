...
def run_audit() -> Dict[str, object]:
    ...
    compare = run_shadow_compare(
        ...
        params={"seed": "compare"},
        context={"trace_id": "compare-session-bootstrap-1674", "user_id": 1, "company_id": 1},
        v1_result={"ok": True, "data": {"intent": "session.bootstrap"}, "meta": {"intent": "session.bootstrap"}},
    ...
    if str(compare.get("intent") or "") != "session.bootstrap":
