...
SNAPSHOT = ROOT / "artifacts" / "v2" / "file_download_contract_snapshot_v1.json"
...
def run_audit() -> Dict[str, object]:
    ...
    if snapshot.get("snapshot_id") != "file_download_contract_snapshot_v1":
    ...
    success = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "file-download-contract-1665-pass"},
    )
    ...
    failure = dispatch_intent(
        intent="file.download",
        payload={"model": "", "res_id": 1, "name": "demo.txt"},
        context={"user_id": 17, "company_id": 5, "trace_id": "file-download-contract-1665-fail"},
    )
