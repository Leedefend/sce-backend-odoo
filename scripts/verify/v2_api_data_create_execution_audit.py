...
def run_audit() -> Dict[str, object]:
    ...
    result = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-create-1651"},
    )
    ...
    if str(data.get("intent") or "") != "api.data.create":
        errors.append("intent_mismatch")
    if str(data.get("model") or "") != "res.partner":
        errors.append("model_mismatch")
    if int(data.get("value_count") or 0) != 1:
        errors.append("value_count_mismatch")
