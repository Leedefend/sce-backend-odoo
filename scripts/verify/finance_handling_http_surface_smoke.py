...
ENTRIES = [
    ...
    },
    {
        ...
        "action_xmlid": f"{MODULE}.action_sc_self_funding_advance_income",
        ...
        "list_domain": [["line_type", "=", "income_visible"]],
        "handled_domain": [["line_type", "=", "income_visible"]],
        "trace_required": False,
    },
    {
        ...
        "action_xmlid": f"{MODULE}.action_sc_self_funding_advance_refund",
        "model": "sc.legacy.self.funding.fact",
        "fields": [
            "id",
            "document_no",
        ...
        "list_domain": [["line_type", "=", "refund_visible"]],
        "handled_domain": [["line_type", "=", "refund_visible"]],
        "trace_required": False,
    },
    {
        "key": "expense_claim",
