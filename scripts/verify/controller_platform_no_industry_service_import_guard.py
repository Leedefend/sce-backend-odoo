...
ARTIFACT_JSON = ROOT / "artifacts" / "controller_platform_no_industry_service_import_guard.json"
FORBIDDEN_PREFIX = "odoo.addons.smart_construction_core.services"
...
def main() -> int:
    ...
    if violations:
        print("[controller_platform_no_industry_service_import_guard] FAIL")
        for item in violations:
            print(item)
        return 1

    print("[controller_platform_no_industry_service_import_guard] PASS")
    return 0
