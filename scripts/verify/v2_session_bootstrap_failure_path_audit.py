...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        payload={"app_key": 123},
        context={"user_id": 7, "company_id": 2, "trace_id": "fail-schema-1622"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="session.bootstrap",
        payload={"app_key": "workspace", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "fail-handler-1622"},
    )
