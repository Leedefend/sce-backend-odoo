...
CATEGORY_ACTIONS = {
    "invoice.output.application": {
        ...
        "domain_tokens": ["source_kind", "output_invoice_tax", "direction", "output", "invoice_content", "销项开票申请"],
        "new_record_tokens": ["invoice_content", "销项开票申请"],
    },
    "invoice.output.registration": {
        ...
        "domain_tokens": ["source_kind", "output_invoice_tax", "direction", "output", "invoice_content", "销项开票登记"],
        "new_record_tokens": ["invoice_content", "销项开票登记"],
    },
    "invoice.prepaid_tax": {
        "label": "预缴税款",
        "model": "sc.invoice.registration",
        ...
        "domain_tokens": ["source_kind", "prepaid_tax", "direction", "prepaid"],
        "new_record_tokens": ["source_kind", "prepaid_tax", "direction", "prepaid"],
    },
    "invoice.input.report": {
        ...
        "domain_tokens": ["source_kind", "input_invoice_tax", "direction", "input", "invoice_content", "进项税额上报"],
        "new_record_tokens": ["invoice_content", "进项税额上报"],
    },
    "tax.deduction.registration": {
        ...
        "domain_tokens": ["is_transfer_out", "False"],
        "new_record_tokens": ["is_transfer_out", "False"],
    },
}
