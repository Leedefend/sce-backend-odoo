...
SNAPSHOT = ROOT / "artifacts" / "v2" / "api_data_unlink_contract_snapshot_v1.json"
...
def run_audit() -> Dict[str, object]:
    ...
    if snapshot.get("snapshot_id") != "api_data_unlink_contract_snapshot_v1":
    ...
    success = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-unlink-contract-1657-pass"},
    )
    ...
    failure = dispatch_intent(
        intent="api.data.unlink",
        payload={"model": "", "ids": [1]},
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-unlink-contract-1657-fail"},
    )
