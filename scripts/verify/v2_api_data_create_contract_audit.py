...
SNAPSHOT = ROOT / "artifacts" / "v2" / "api_data_create_contract_snapshot_v1.json"
...
def run_audit() -> Dict[str, object]:
    ...
    if snapshot.get("snapshot_id") != "api_data_create_contract_snapshot_v1":
    ...
    success = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-create-contract-1653-pass"},
    )
    ...
    if str(meta.get("intent") or "") != "api.data.create":
    ...
    failure = dispatch_intent(
        intent="api.data.create",
        payload={"model": "", "values": {"name": "Demo"}},
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-create-contract-1653-fail"},
    )
