...
SNAPSHOT = ROOT / "artifacts" / "v2" / "api_data_contract_snapshot_v1.json"
...
def run_audit() -> Dict[str, object]:
    ...
    if snapshot.get("snapshot_id") != "api_data_contract_snapshot_v1":
    ...
    success = dispatch_intent(
        ...
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-contract-1641-pass"},
    )
    ...
    if str(meta.get("intent") or "") != "api.data":
    ...
    failure = dispatch_intent(
        intent="api.data",
        payload={"model": "", "operation": "read"},
        context={"user_id": 17, "company_id": 5, "trace_id": "api-data-contract-1641-fail"},
    )
