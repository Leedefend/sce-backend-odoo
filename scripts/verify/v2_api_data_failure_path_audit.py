...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-fail-schema-1639"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="api.data",
        payload={"model": "res.partner", "operation": "read", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "api-data-fail-handler-1639"},
    )
