...
CATEGORY_ACTIONS = {
    ...
    "finance.expense.reimbursement": {
        ...
        "domain_tokens": ["claim_type", "expense", "expense_type", "报销申请"],
        "new_record_tokens": ["expense_type", "报销申请"],
    },
    "finance.expense.project": {
        ...
        "new_record_tokens": ["expense_type", "项目费用报销单"],
    },
    "finance.deposit.bid.pay": {
        ...
        "new_record_tokens": ["guarantee_type", "bid"],
    },
    ...
    "finance.deposit.contract.pay": {
        ...
        "new_record_tokens": ["guarantee_type", "contract"],
    },
    ...
    "finance.deduction.bill": {
        ...
        "domain_tokens": ["claim_type", "expense", "expense_type", "扣款单"],
        "new_record_tokens": ["expense_type", "扣款单"],
    },
    "finance.deduction.paid": {
        ...
        "domain_tokens": ["expense_type", "扣款实缴登记"],
        "new_record_tokens": ["expense_type", "扣款实缴登记"],
    },
    "finance.deduction.refund": {
        ...
        "domain_tokens": ["expense_type", "扣款实缴退回"],
        "new_record_tokens": ["expense_type", "扣款实缴退回"],
    },
    ...
    "finance.repayment.registration": {
        ...
        "domain_tokens": ["claim_type", "project_company_repay", "expense_type", "还款登记"],
        "new_record_tokens": ["expense_type", "还款登记"],
    },
    "finance.repayment.contractor_project": {
        ...
        "domain_tokens": ["expense_type", "承包人还项目款"],
        "new_record_tokens": ["expense_type", "承包人还项目款"],
    },
    "finance.repayment.project_company": {
        ...
        "domain_tokens": ["claim_type", "project_company_repay", "expense_type", "项目还公司款登记"],
        "new_record_tokens": ["expense_type", "项目还公司款登记"],
    },
}
