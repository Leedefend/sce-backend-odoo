...
def run_audit() -> Dict[str, object]:
    ...
    schema_fail = dispatch_intent(
        ...
        context={"user_id": 7, "company_id": 2, "trace_id": "api-onchange-fail-schema-1643"},
    )
    _assert_failure_shape(schema_fail, errors, "schema_fail")

    handler_fail = dispatch_intent(
        intent="api.onchange",
        payload={"model": "res.partner", "field_name": "name", "raise_handler_error": True},
        context={"user_id": 7, "company_id": 2, "trace_id": "api-onchange-fail-handler-1643"},
    )
