"""Build no-DB authorization packet for project v4 200-row candidate."""
...
CANDIDATE_CSV = Path("artifacts/migration/project_next_200_candidate_v4.csv")
DRY_RUN_JSON = Path("artifacts/migration/project_next_200_dry_run_result_v4.json")
OUTPUT_JSON = Path("artifacts/migration/project_v4_200_write_authorization_packet.json")
TARGET_COUNT = 200
...
payload = {
    ...
    "mode": "project_v4_200_write_authorization_packet_no_db",
...
print(
    "PROJECT_V4_200_WRITE_AUTH_PACKET="
    + json.dumps(
        {
