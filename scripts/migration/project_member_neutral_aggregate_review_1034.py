"""Readonly aggregate review for 1034 project_member neutral carrier rows."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_member_neutral_aggregate_review_1034_v1.json")
...
def main():
    ...
    payload = {
        ...
        "mode": "project_member_neutral_aggregate_review_1034",
    ...
    print("PROJECT_MEMBER_NEUTRAL_AGGREGATE_REVIEW_1034=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"project_member_neutral_aggregate_review_1034_failed": blocking_reasons})
