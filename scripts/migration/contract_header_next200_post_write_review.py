"""Readonly post-write review for the next 200-row contract header write batch."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/contract_header_next200_post_write_review_result_v1.json")
EXPECTED_COUNT = 200
...
def main():
    ...
    payload = {
        ...
        "mode": "contract_header_next200_post_write_readonly_review",
    ...
    print(
        "CONTRACT_HEADER_NEXT200_POST_WRITE_REVIEW="
        + json.dumps(
            {
    ...
    if blocking_reasons:
        raise RuntimeError({"contract_header_next200_post_write_review_failed": blocking_reasons})
