"""Readonly post-write review for the post1000 next 200-row contract header write batch."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/contract_header_post1000_next200_post_write_review_result_v1.json")
EXPECTED_COUNT = 200
...
def main():
    ...
    payload = {
        ...
        "mode": "contract_header_post1000_next200_post_write_readonly_review",
    ...
    print(
        "CONTRACT_HEADER_POST1000_NEXT200_POST_WRITE_REVIEW="
        + json.dumps(
            {
    ...
    if blocking_reasons:
        raise RuntimeError({"contract_header_post1000_next200_post_write_review_failed": blocking_reasons})
