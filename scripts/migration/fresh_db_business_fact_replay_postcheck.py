...
EXPECTED_PROJECT_ROWS = int(os.getenv("BUSINESS_FACT_EXPECTED_PROJECT_ROWS", "810"))
EXPECTED_CONTRACT_TOTAL = int(os.getenv("BUSINESS_FACT_EXPECTED_CONTRACT_TOTAL", "6985"))
EXPECTED_INCOME_CONTRACTS = int(os.getenv("BUSINESS_FACT_EXPECTED_INCOME_CONTRACTS", "1537"))
EXPECTED_EXPENSE_CONTRACTS = int(os.getenv("BUSINESS_FACT_EXPECTED_EXPENSE_CONTRACTS", "5448"))
EXPECTED_CONTRACT_LINES = int(os.getenv("BUSINESS_FACT_EXPECTED_CONTRACT_LINES", "6566"))
EXPECTED_GENERAL_CONTRACTS = int(os.getenv("BUSINESS_FACT_EXPECTED_GENERAL_CONTRACTS", "45"))
