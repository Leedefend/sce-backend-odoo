...
LANES = [
    ...
    ("user_security_context", 20, ("legacy_user", "real_user", "user_rebuild")),
    ("master_partner_project", 30, ("partner", "project_anchor", "project_member")),
    ("contract_and_supplier", 40, ("contract", "supplier")),
    ("receipt_income", 50, ("receipt", "legacy_receipt", "receipt_income")),
    ("outflow_payment", 60, ("outflow", "actual_outflow", "payment")),
    ("finance_accounting", 70, ("legacy_account", "legacy_invoice", "legacy_tax", "legacy_fund", "legacy_expense", "legacy_payment", "legacy_self_funding", "legacy_financing")),
