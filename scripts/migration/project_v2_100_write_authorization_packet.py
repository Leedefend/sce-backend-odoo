"""Build no-DB authorization packet for project v2 100-row candidate."""
...
CANDIDATE_CSV = Path("artifacts/migration/project_next_100_candidate_v2.csv")
DRY_RUN_JSON = Path("artifacts/migration/project_next_100_dry_run_result_v2.json")
OUTPUT_JSON = Path("artifacts/migration/project_v2_100_write_authorization_packet.json")
...
payload = {
    ...
    "mode": "project_v2_100_write_authorization_packet_no_db",
...
print(
    "PROJECT_V2_100_WRITE_AUTH_PACKET="
    + json.dumps(
        {
