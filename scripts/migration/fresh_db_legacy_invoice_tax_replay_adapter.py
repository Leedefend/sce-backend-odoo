#!/usr/bin/env python3
"""Build replay payload for legacy invoice tax facts."""
...
INPUT_XML = REPO_ROOT / "migration_assets/30_relation/legacy_invoice_tax/legacy_invoice_tax_v1.xml"
OUTPUT_CSV = REPO_ROOT / "artifacts/migration/fresh_db_legacy_invoice_tax_replay_payload_v1.csv"
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/fresh_db_legacy_invoice_tax_replay_adapter_result_v1.json"
