"""Create partner records for company duplicate-group rows."""
...
PRE_WRITE_SNAPSHOT_CSV = Path("/mnt/artifacts/migration/partner_l4_company_duplicate_24_pre_write_snapshot_v1.csv")
POST_WRITE_SNAPSHOT_CSV = Path("/mnt/artifacts/migration/partner_l4_company_duplicate_24_post_write_snapshot_v1.csv")
...
EXPECTED_COUNT = 24
RUN_ID = "ITER-2026-04-14-PARTNER-L4-COMPANY-DUPLICATE-24-WRITE"
...
def main():
    ...
    for index, row in enumerate(rows, start=2):
        row_errors = []
        if clean(row.get("proposed_action")) != "create_company_partner_with_tax_number":
