#!/usr/bin/env python3
"""Build targeted replay payload for missing receipt-parent partner anchors."""
...
RECEIPT_PARENT_PAYLOAD_CSV = REPO_ROOT / "artifacts/migration/history_receipt_parent_recovery_payload_v1.csv"
...
OUTPUT_CSV = REPO_ROOT / "artifacts/migration/history_receipt_partner_targeted_replay_payload_v1.csv"
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/history_receipt_partner_targeted_replay_adapter_result_v1.json"
...
def main() -> int:
    rows = read_csv(RECEIPT_PARENT_PAYLOAD_CSV)
    ...
    payload = {
        "status": "PASS",
        "mode": "history_receipt_partner_targeted_replay_adapter",
