"""Create-only write for the approved post1000 next 200-row contract header payload."""
...
PAYLOAD_CSV = Path("/mnt/artifacts/migration/contract_header_post1000_next200_authorization_payload_v1.csv")
PACKET_JSON = Path("/mnt/artifacts/migration/contract_header_post1000_next200_authorization_packet_v1.json")
PRE_WRITE_SNAPSHOT_CSV = Path("/mnt/artifacts/migration/contract_header_post1000_next200_pre_write_snapshot_v1.csv")
POST_WRITE_SNAPSHOT_CSV = Path("/mnt/artifacts/migration/contract_header_post1000_next200_post_write_snapshot_v1.csv")
WRITE_RESULT_JSON = Path("/mnt/artifacts/migration/contract_header_post1000_next200_write_result_v1.json")
ROLLBACK_TARGET_CSV = Path("/mnt/artifacts/migration/contract_header_post1000_next200_rollback_targets_v1.csv")

RUN_ID = "ITER-2026-04-15-CONTRACT-POST1000-NEXT200"
EXPECTED_COUNT = 200
SAFE_FIELDS = {
    "legacy_contract_id",
    "legacy_project_id",
...
def main():
    ...
    payload = {
        ...
        "mode": "contract_header_post1000_next200_create_only_write",
    ...
    print(
        "CONTRACT_HEADER_POST1000_NEXT200_CREATE_WRITE="
        + json.dumps(
            {
    ...
    if post_errors:
        raise RuntimeError({"contract_header_post1000_next200_write_failed": post_errors})
