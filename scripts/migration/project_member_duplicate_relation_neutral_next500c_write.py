"""Inlined writer for the next500c project_member neutral carrier."""
...
PRE_VISIBILITY_JSON = Path("/mnt/artifacts/migration/project_member_duplicate_relation_next500c_pre_visibility_v1.json")
POST_VISIBILITY_JSON = Path("/mnt/artifacts/migration/project_member_duplicate_relation_next500c_post_visibility_v1.json")
WRITE_RESULT_JSON = Path("/mnt/artifacts/migration/project_member_duplicate_relation_next500c_write_result_v1.json")
ROLLBACK_TARGET_CSV = Path("/mnt/artifacts/migration/project_member_duplicate_relation_next500c_rollback_targets_v1.csv")

RUN_ID = "ITER-2026-04-14-1980N"
...
def main():
    ...
    payload = {
        ...
        "mode": "project_member_duplicate_relation_neutral_next500c_write",
    ...
    print("PROJECT_MEMBER_DUPLICATE_RELATION_NEUTRAL_NEXT500C_WRITE=" + json.dumps({
    ...
    if post_errors:
        raise RuntimeError({"duplicate_relation_neutral_next500c_write_failed": post_errors})
