#!/usr/bin/env python3
"""Replay targeted outflow-request partner anchors into allowed DBs."""
...
def repo_root() -> Path:
    ...
    for candidate in candidates:
        if (candidate / "artifacts/migration/history_outflow_partner_targeted_replay_payload_v1.csv").exists():
            return candidate
    return Path.cwd()
...
INPUT_CSV = REPO_ROOT / "artifacts/migration/history_outflow_partner_targeted_replay_payload_v1.csv"
OUTPUT_JSON = ARTIFACT_ROOT / "history_outflow_partner_targeted_replay_write_result_v1.json"
ROLLBACK_CSV = ARTIFACT_ROOT / "history_outflow_partner_targeted_replay_rollback_targets_v1.csv"
...
result = {
    "status": "PASS",
    "mode": "history_outflow_partner_targeted_replay_write",
