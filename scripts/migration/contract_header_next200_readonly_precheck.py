#!/usr/bin/env python3
"""Readonly DB precheck for the next 200-row contract header slice."""
...
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/contract_header_next200_readonly_precheck_result_v1.json"
...
def main():
    ...
    payload = {
        ...
        "mode": "contract_header_next200_readonly_precheck",
        "database": DB_NAME,
    ...
    print(
        "CONTRACT_HEADER_NEXT200_READONLY_PRECHECK="
        + json.dumps(
            {
