"""Readonly aggregate review for 5034 project_member neutral carrier rows."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_member_neutral_aggregate_review_5034_v1.json")
...
def main():
    ...
    payload = {
        ...
        "mode": "project_member_neutral_aggregate_review_5034",
    ...
    print("PROJECT_MEMBER_NEUTRAL_AGGREGATE_REVIEW_5034=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"project_member_neutral_aggregate_review_5034_failed": blocking_reasons})
