"""Create-only 100-row project v2 write for Odoo shell."""
...
INPUT_CSV = Path("/mnt/artifacts/migration/project_next_100_candidate_v2.csv")
PACKET_JSON = Path("/mnt/artifacts/migration/project_v2_100_write_authorization_packet.json")
PRE_WRITE_SNAPSHOT_CSV = Path("/mnt/artifacts/migration/project_v2_100_pre_write_snapshot.csv")
...
def main():
    ...
    payload = {
        ...
        "mode": "project_v2_100_create_only_write",
    ...
    print("PROJECT_V2_100_WRITE_RESULT=" + json.dumps(payload["summary"], ensure_ascii=False, sort_keys=True))
    if post_errors:
