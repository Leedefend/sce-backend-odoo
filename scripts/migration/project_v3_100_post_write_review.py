"""Readonly post-write review for the project v3 100-row write batch."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_v3_100_post_write_review_result.json")
ROLLBACK_TARGET_CSV = Path("/mnt/artifacts/migration/project_v3_100_rollback_target_list.csv")
EXPECTED_COUNT = 100
...
def main():
    ...
    payload = {
        ...
        "mode": "project_v3_100_post_write_readonly_review",
    ...
    print(
        "PROJECT_V3_100_POST_WRITE_REVIEW="
        + json.dumps(
            {
    ...
    if blocking_reasons:
        raise RuntimeError({"project_v3_post_write_review_failed": blocking_reasons})
