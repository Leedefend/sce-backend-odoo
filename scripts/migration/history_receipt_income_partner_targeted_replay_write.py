#!/usr/bin/env python3
"""Replay targeted receipt-income partner anchors into allowed replay databases."""
...
def repo_root() -> Path:
    ...
    for candidate in candidates:
        if (candidate / "artifacts/migration/history_receipt_income_partner_targeted_replay_payload_v1.csv").exists():
            return candidate
    return Path.cwd()
...
INPUT_CSV = REPO_ROOT / "artifacts/migration/history_receipt_income_partner_targeted_replay_payload_v1.csv"
OUTPUT_JSON = ARTIFACT_ROOT / "history_receipt_income_partner_targeted_replay_write_result_v1.json"
...
payload = {
    "status": "PASS",
    "mode": "history_receipt_income_partner_targeted_replay_write",
...
print("HISTORY_RECEIPT_INCOME_PARTNER_TARGETED_REPLAY_WRITE=" + json.dumps(payload, ensure_ascii=False, sort_keys=True))
