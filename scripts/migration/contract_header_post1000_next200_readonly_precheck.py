#!/usr/bin/env python3
"""Readonly DB precheck for the post1000 next 200-row contract header slice."""
...
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/contract_header_post1000_next200_readonly_precheck_result_v1.json"
...
def main():
    ...
    payload = {
        ...
        "mode": "contract_header_post1000_next200_readonly_precheck",
        "database": DB_NAME,
    ...
    print(
        "CONTRACT_HEADER_POST1000_NEXT200_READONLY_PRECHECK="
        + json.dumps(
            {
