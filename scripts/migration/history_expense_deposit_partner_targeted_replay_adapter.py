#!/usr/bin/env python3
"""Build targeted replay payload for missing legacy expense-deposit partner anchors."""
...
EXPENSE_DEPOSIT_PAYLOAD_CSV = REPO_ROOT / "artifacts/migration/fresh_db_legacy_expense_deposit_replay_payload_v1.csv"
...
OUTPUT_CSV = REPO_ROOT / "artifacts/migration/history_expense_deposit_partner_targeted_replay_payload_v1.csv"
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/history_expense_deposit_partner_targeted_replay_adapter_result_v1.json"
...
def main() -> int:
    rows = read_csv(EXPENSE_DEPOSIT_PAYLOAD_CSV)
    ...
    payload = {
        "status": "PASS",
        "mode": "history_expense_deposit_partner_targeted_replay_adapter",
