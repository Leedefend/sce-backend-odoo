...
SELECT
  ...
  '' AS handler_phone,
  '' AS regional_tax_contact,
  '' AS regional_tax_contact_phone,
  '' AS operation_address,
  '' AS tax_report_management_no,
  '' AS taxpayer_name,
  '' AS taxpayer_identifier,
  '' AS contract_name,
  '' AS contract_start_date,
  '' AS contract_end_date,
  '' AS counterparty_tax_identifier,
...
SELECT
  ...
  {clean_sql("h.FJ")} AS attachment_ref,
  {clean_sql("h.JBRSJ")} AS handler_phone,
  {clean_sql("h.QYSSSXLXR")} AS regional_tax_contact,
  {clean_sql("h.QYSSSXLXRSJ")} AS regional_tax_contact_phone,
  {clean_sql("h.KQYJYDZ")} AS operation_address,
  {clean_sql("h.KQYSSSXBYGLBH")} AS tax_report_management_no,
  {clean_sql("h.NSRMC")} AS taxpayer_name,
  {clean_sql("h.NSRSBH")} AS taxpayer_identifier,
  {clean_sql("h.HTMC")} AS contract_name,
  {date_sql("h.HTKSRQ")} AS contract_start_date,
  {date_sql("h.HTJSRQ")} AS contract_end_date,
  {clean_sql("h.HTXDFMCNSRSBH")} AS counterparty_tax_identifier,
