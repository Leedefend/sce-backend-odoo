"""Readonly post-write review for company/supplier pair merged partner write."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/partner_l4_company_supplier_pair_1713_post_write_review_result_v1.json")
EXPECTED_COUNT = 1713
...
def main():
    ...
    payload = {
        ...
        "mode": "partner_company_supplier_pair_post_write_readonly_review",
    ...
    print("PARTNER_COMPANY_SUPPLIER_PAIR_POST_WRITE_REVIEW=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"partner_company_supplier_pair_post_write_review_failed": blocking_reasons})
