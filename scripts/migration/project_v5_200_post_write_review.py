"""Readonly post-write review for the project v5 200-row write batch."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_v5_200_post_write_review_result.json")
ROLLBACK_TARGET_CSV = Path("/mnt/artifacts/migration/project_v5_200_rollback_target_list.csv")
EXPECTED_COUNT = 200
...
def main():
    ...
    payload = {
        ...
        "mode": "project_v5_200_post_write_readonly_review",
    ...
    print("PROJECT_V5_200_POST_WRITE_REVIEW=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"project_v5_post_write_review_failed": blocking_reasons})
