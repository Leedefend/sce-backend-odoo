#!/usr/bin/env python3
"""Replay targeted partner-master anchors required by UR-B into allowed DBs."""
...
def repo_root() -> Path:
    ...
    for candidate in candidates:
        if (candidate / "artifacts/migration/history_partner_master_targeted_replay_payload_v1.csv").exists():
            return candidate
    return Path.cwd()
...
INPUT_CSV = REPO_ROOT / "artifacts/migration/history_partner_master_targeted_replay_payload_v1.csv"
OUTPUT_JSON = ARTIFACT_ROOT / "history_partner_master_targeted_replay_write_result_v1.json"
ROLLBACK_CSV = ARTIFACT_ROOT / "history_partner_master_targeted_replay_rollback_targets_v1.csv"
EXPECTED_ROWS = 4
...
result = {
    ...
    "mode": "history_partner_master_targeted_replay_write",
