"""Readonly review for company/supplier duplicate 26 partner write."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/partner_l4_company_supplier_duplicate_26_post_write_review_result_v1.json")
EXPECTED_COUNT = 26
...
def main():
    ...
    payload = {
        ...
        "mode": "partner_company_supplier_duplicate_26_post_write_readonly_review",
    ...
    print("PARTNER_COMPANY_SUPPLIER_DUPLICATE_26_POST_WRITE_REVIEW=" + json.dumps({"status": payload["status"], "design_rows": payload["design_rows"], "rollback_target_rows": payload["rollback_target_rows"], "matched_partner_rows": payload["matched_partner_rows"], "rollback_eligible_rows": payload["rollback_eligible_rows"], "blocking_reasons": payload["blocking_reasons"]}, ensure_ascii=False, sort_keys=True))
    if blocking_reasons:
        raise RuntimeError({"partner_company_supplier_duplicate_26_post_write_review_failed": blocking_reasons})
