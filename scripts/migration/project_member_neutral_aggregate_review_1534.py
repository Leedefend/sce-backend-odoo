"""Readonly aggregate review for 1534 project_member neutral carrier rows."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_member_neutral_aggregate_review_1534_v1.json")
...
def main():
    ...
    payload = {
        ...
        "mode": "project_member_neutral_aggregate_review_1534",
    ...
    print("PROJECT_MEMBER_NEUTRAL_AGGREGATE_REVIEW_1534=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"project_member_neutral_aggregate_review_1534_failed": blocking_reasons})
