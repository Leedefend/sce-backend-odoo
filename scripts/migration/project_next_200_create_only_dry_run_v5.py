"""Build and dry-run the next non-overlapping 200-row project candidate v5."""
...
OUTPUT_CSV = Path("artifacts/migration/project_next_200_candidate_v5.csv")
OUTPUT_JSON = Path("artifacts/migration/project_next_200_dry_run_result_v5.json")
TARGET_COUNT = 200
...
payload = {
    "status": "PASS" if len(selected) == TARGET_COUNT and not errors else "FAIL",
    "mode": "project_next_200_create_only_dry_run_v5_no_db_no_orm",
    ...
    "errors": errors,
    "results": results,
    "next_step": "open write authorization packet for this v5 200-row project create-only candidate",
}
write_json(OUTPUT_JSON, payload)
print(
    "PROJECT_NEXT_200_DRY_RUN_V5="
    + json.dumps(
        {
