...
run_adapters() {
  ...
  python3 "$ROOT_DIR/scripts/migration/fresh_db_legacy_fund_confirmation_header_replay_adapter.py"
  ...
  python3 "$ROOT_DIR/scripts/migration/fresh_db_legacy_business_fact_residual_replay_adapter.py"
...
run_writes() {
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_new_construction_contract_xlsx_income_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_income_fact_project_stub_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/visible_surface_payment_request_contract_normalize_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/visible_surface_receipt_core_creator_normalize_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/visible_surface_receipt_invoice_line_normalize_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_project_task_projection_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_legacy_fund_confirmation_header_replay_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_legacy_business_fact_residual_replay_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_tender_registration_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_material_stock_document_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_project_budget_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_labor_equipment_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_work_breakdown_projection_write.py"
  ...
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_office_admin_leave_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_office_admin_seal_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_hr_payroll_salary_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_hr_payroll_social_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_hr_payroll_allowance_bonus_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_document_certificate_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_document_borrow_projection_write.py"
  run_odoo_script "$ROOT_DIR/scripts/migration/fresh_db_document_admin_archive_projection_write.py"
}
