"""Readonly review for same-tax company canonical 20 partner write."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/partner_l4_same_tax_company_canonical_20_post_write_review_result_v1.json")
EXPECTED_COUNT = 20
