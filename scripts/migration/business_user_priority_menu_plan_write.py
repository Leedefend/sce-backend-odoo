...
def entry(
    ...
    *,
    ...
    return {
        ...
        "target_iteration": "next_special_topic",
...
ENTRIES = [
    ...
    entry(40, "办公资料", "公司资料存档", "document_archive", "image1", "公司资料与附件台账专题", tables="BASE_SYSTEM_FILE; sc.legacy.file.index", fields="资料名称; 文件分类; 附件; 上传人; 上传时间"),
    entry(50, "人事行政", "请假/休假审批单", "hr_admin", "image1", "人事行政审批专题", tables="BGGL_HBZJ_XZD_QJXJSPB", fields="申请人; 部门; 请假类型; 开始时间; 结束时间; 审批状态"),
    entry(60, "人事行政", "印章使用审批表", "office_admin", "image1", "印章使用审批专题", tables="BGGL_*印章*; residual office_admin", fields="申请人; 印章类型; 使用事项; 使用日期; 审批状态"),
    ...
    entry(90, "人事行政", "社保人员登记", "hr_admin", "image1", "社保人员登记专题", tables="BGGL_RSGL_*; residual office_admin", fields="人员; 身份证; 社保基数; 缴纳单位; 状态"),
    entry(100, "人事行政", "社保登记", "hr_admin", "image1", "社保登记专题", tables="BGGL_RSGL_*; residual office_admin", fields="期间; 人员; 公司缴纳; 个人缴纳; 合计"),
    ...
    entry(120, "人事行政", "补助", "hr_admin", "image1", "补助奖金专题", tables="BGGL_XZ_BZ", fields="项目; 人员; 补助类型; 金额; 日期"),
    entry(130, "人事行政", "奖金", "hr_admin", "image1", "补助奖金专题", tables="BGGL_XZ_JXDJ; BGGL_XZ_JXDJ_ZB", fields="项目; 人员; 奖金类型; 金额; 日期"),
    entry(140, "证照资料", "证照登记", "document_archive", "image1", "证照资料专题", tables="DataSpider_ScjstPersonCertificate; residual document_admin", fields="证照名称; 编号; 持有人; 有效期; 附件"),
    entry(150, "证照资料", "借阅申请", "document_archive", "image1", "资料借阅专题", tables="BGGL_QT_*; residual office_admin", fields="借阅人; 资料名称; 借阅日期; 归还日期; 审批状态"),
    ...
    entry(170, "投标", "投标报名费申请", "bid_tender", "image1", "投标报名费专题", tables="BGGL_ZTBJHT_TBBM_TBBMFSQ", fields="单号; 项目; 往来单位; 报名费; 保证金; 申请人"),
    ...
    entry(210, "资金保证金", "付款还保证金退回", "treasury", "image1", "付款保证金退回专题", tables="C_FKGL_*; sc.legacy.payment.adjustment.fact", fields="项目; 往来单位; 退回金额; 日期; 原付款单"),
    ...
    entry(230, "资金借还", "还款登记", "treasury", "image1", "还款登记专题", tables="sc.legacy.financing.loan.fact; sc.legacy.account.transaction.line", fields="项目; 还款人; 还款金额; 日期; 账户"),
    ...
    entry(270, "项目资金", "承包人还项目款", "treasury", "image2", "承包人项目借还款专题", tables="sc.legacy.project.fund.balance.fact; sc.legacy.account.transaction.line", fields="项目; 承包人; 还款金额; 日期; 账户"),
    entry(280, "项目资金", "承包人借项目款", "treasury", "image2", "承包人项目借还款专题", tables="sc.legacy.project.fund.balance.fact; sc.legacy.financing.loan.fact", fields="项目; 承包人; 借款金额; 日期; 状态"),
    ...
    entry(330, "扣款", "扣款实缴登记", "deduction", "image2", "扣款实缴专题", tables="sc.legacy.deduction.adjustment.line", fields="项目; 单位; 实缴金额; 日期; 原扣款单"),
    entry(340, "扣款", "扣款实缴退回", "deduction", "image2", "扣款实缴退回专题", tables="sc.legacy.deduction.adjustment.line; sc.legacy.payment.adjustment.fact", fields="项目; 单位; 退回金额; 日期; 原扣款单"),
    ...
    entry(370, "项目资金", "项目借公司款登记", "treasury", "image2", "项目与公司借还款专题", tables="sc.legacy.project.fund.balance.fact; sc.legacy.financing.loan.fact", fields="项目; 公司; 借款金额; 日期; 状态"),
    entry(380, "项目资金", "项目还公司款登记", "treasury", "image2", "项目与公司借还款专题", tables="sc.legacy.project.fund.balance.fact; sc.legacy.account.transaction.line", fields="项目; 公司; 还款金额; 日期; 账户"),
    entry(390, "发票税务", "开票申请", "invoice_tax", "image2", "开票申请专题", tables="sc.invoice.registration; sc.legacy.invoice.registration.line", fields="项目; 客户; 开票金额; 税率; 申请日期"),
    ...
    entry(440, "发票税务", "外经证登记", "invoice_tax", "image2", "外经证登记专题", tables="sc.legacy.finance.auxiliary.fact; residual invoice_tax", fields="项目; 外经证编号; 机构; 有效期; 附件"),
