"""Readonly aggregate review for 4534 project_member neutral carrier rows."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_member_neutral_aggregate_review_4534_v1.json")
...
def main():
    ...
    payload = {
        ...
        "mode": "project_member_neutral_aggregate_review_4534",
    ...
    print("PROJECT_MEMBER_NEUTRAL_AGGREGATE_REVIEW_4534=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"project_member_neutral_aggregate_review_4534_failed": blocking_reasons})
