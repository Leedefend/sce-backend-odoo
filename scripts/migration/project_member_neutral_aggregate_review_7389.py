"""Readonly aggregate review for 7389 project_member neutral carrier rows."""
...
OUTPUT_JSON = Path("/mnt/artifacts/migration/project_member_neutral_aggregate_review_7389_v1.json")
...
EXPECTED_BATCH_COUNTS = {
    ...
    "ITER-2026-04-15-1988N": 500,
    "ITER-2026-04-15-1990N": 500,
    "ITER-2026-04-15-1992N": 500,
    "ITER-2026-04-15-1994N": 500,
    "ITER-2026-04-15-1996N": 500,
    "ITER-2026-04-15-1998N": 500,
    "ITER-2026-04-15-2000N": 500,
    "ITER-2026-04-15-2002N": 355,
}
...
def main():
    ...
    payload = {
        ...
        "mode": "project_member_neutral_aggregate_review_7389",
    ...
    print("PROJECT_MEMBER_NEUTRAL_AGGREGATE_REVIEW_7389=" + json.dumps({
    ...
    if blocking_reasons:
        raise RuntimeError({"project_member_neutral_aggregate_review_7389_failed": blocking_reasons})
