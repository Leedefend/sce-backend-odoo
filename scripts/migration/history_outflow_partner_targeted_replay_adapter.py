#!/usr/bin/env python3
"""Build targeted replay payload for outflow-request partner anchors."""
...
OUTFLOW_PAYLOAD_CSV = REPO_ROOT / "artifacts/migration/fresh_db_outflow_request_replay_payload_v1.csv"
...
OUTPUT_CSV = REPO_ROOT / "artifacts/migration/history_outflow_partner_targeted_replay_payload_v1.csv"
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/history_outflow_partner_targeted_replay_adapter_result_v1.json"
...
def main() -> int:
    rows = read_csv(OUTFLOW_PAYLOAD_CSV)
    ...
    payload = {
        "status": "PASS",
        "mode": "history_outflow_partner_targeted_replay_adapter",
