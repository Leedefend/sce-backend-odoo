#!/usr/bin/env python3
"""Build targeted replay payload for actual-outflow partner anchors."""
...
ACTUAL_OUTFLOW_PAYLOAD_CSV = REPO_ROOT / "artifacts/migration/fresh_db_actual_outflow_replay_payload_v1.csv"
...
OUTPUT_CSV = REPO_ROOT / "artifacts/migration/history_actual_outflow_partner_targeted_replay_payload_v1.csv"
OUTPUT_JSON = REPO_ROOT / "artifacts/migration/history_actual_outflow_partner_targeted_replay_adapter_result_v1.json"
...
def main() -> int:
    rows = read_csv(ACTUAL_OUTFLOW_PAYLOAD_CSV)
    ...
    payload = {
        "status": "PASS",
        "mode": "history_actual_outflow_partner_targeted_replay_adapter",
