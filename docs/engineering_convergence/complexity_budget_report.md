...
| Lines | Category | File |
| ---: | --- | --- |
| 12674 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| ---: | --- | --- | --- |
| 12674 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
