...
| Lines | Category | File |
| ---: | --- | --- |
| 11691 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| ---: | --- | --- | --- |
| 11691 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
