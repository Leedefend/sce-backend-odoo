...
| Lines | Category | File |
| ---: | --- | --- |
| 12470 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| ---: | --- | --- | --- |
| 12470 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
