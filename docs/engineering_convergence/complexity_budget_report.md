...
| Lines | Category | File |
| ---: | --- | --- |
| 12542 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| ---: | --- | --- | --- |
| 12542 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
