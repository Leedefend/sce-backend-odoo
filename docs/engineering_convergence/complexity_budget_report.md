...
| Lines | Category | File |
| ---: | --- | --- |
| 12767 | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
...
| ---: | --- | --- | --- |
| 12767 | split_plan_required | Vue source | `frontend/apps/web/src/pages/ContractFormPage.vue` |
