...
| Disposition | Count |
| --- | ---: |
| deduplicate_before_required | 579 |
...
| Family | Count |
| --- | ---: |
| `scripts/verify/contract_governance_form` | 3 |
...
| --- | ---: | --- | --- | --- |
| `scripts/verify/contract_governance_form` | 3 | test owner | requires owner review | Requires owner review before mapping to an aggregate gate. |
