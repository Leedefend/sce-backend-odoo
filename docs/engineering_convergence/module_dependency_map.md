...
| `smart_construction_bundle` | 0.1.0 | yes | no | smart_core | - | - |
| `smart_construction_core` | 17.0.0.67 | yes | yes | smart_core | account, auth_signup, base_tier_validation, base_tier_validation_server_action, hr, mail, product, project, purchase, stock, uom, web | sc_norm_engine, smart_construction_custom, smart_construction_demo, smart_construction_portal, smart_construction_scene, smart_construction_seed |
| `smart_construction_custom` | 17.0.1.1 | yes | no | smart_construction_core | - | smart_construction_demo |
| `smart_construction_demo` | 0.2.0 | yes | no | smart_construction_core, smart_construction_custom | account | - |
| `smart_construction_portal` | 17.0.1.1 | yes | no | smart_construction_core | web | - |
| `smart_construction_scene` | 17.0.0.3 | yes | no | smart_construction_core, smart_scene | - | - |
| `smart_construction_seed` | 17.0.0.2.1 | yes | no | smart_construction_bootstrap, smart_construction_core | account | - |
| `smart_core` | 17.0.1.3 | yes | no | - | base, web | smart_construction_bundle, smart_construction_core, smart_license_core, smart_owner_bundle, smart_owner_core, smart_scene |
| `smart_license_core` | 0.1.0 | yes | no | smart_core | - | - |
| `smart_owner_bundle` | 0.1.0 | yes | no | smart_core, smart_owner_core | - | - |
| `smart_owner_core` | 0.1.0 | yes | no | smart_core | - | smart_owner_bundle |
| `smart_scene` | 1.0.0 | yes | no | smart_core | base | smart_construction_scene |
...
| `smart_construction_custom` | `smart_construction_core` |
| `smart_construction_demo` | `smart_construction_core` |
| `smart_construction_demo` | `smart_construction_custom` |
