...
| `smart_core` | 17.0.1.0 | yes | no | - | base, web | smart_construction_bundle, smart_construction_core, smart_license_core, smart_owner_bundle, smart_owner_core, smart_scene |
