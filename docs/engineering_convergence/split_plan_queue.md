...
| P0 | 3334 | Frontend owner | `frontend/apps/web/src/views/BusinessConfigSurfaceView.vue` | Extract composables, child panels, data adapters, and action handlers; keep the route component as orchestration shell. |
