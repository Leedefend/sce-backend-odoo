...
| P0 | 6062 | DevOps owner | `Makefile` | Move implementation bodies into `scripts/ci`, `scripts/verify`, or included `make/*.mk` fragments while keeping stable public targets. |
