...
| E2E-02: Cost engineer imports BOQ. | gap | - | Create fixed-data browser/API journey with screenshots, logs, request/response evidence. |
| E2E-03: Project manager generates WBS or tasks from BOQ. | gap | - | Create fixed-data browser/API journey with screenshots, logs, request/response evidence. |
...
| E2E-08: Settlement user creates and approves settlement. | gap | - | Create fixed-data browser/API journey with screenshots, logs, request/response evidence. |
