...
1. Enable branch protection after the workflow is visible.
2. Mark `v1.1 quality gate / quality-gate` as required after the first GitHub Actions run is available.
