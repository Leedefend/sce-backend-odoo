...
| `frontend/apps/web/src/pages/ContractFormPage.vue` | P4-P0-03 in progress: shared contract form types/constants, action parsing helpers, contract record helpers, field/date/relation display helpers, and access-policy normalization extracted; route component reduced from 13762 to 13393 lines without changing product behavior. | `@Leedefend` | Local and remote gates passed |
