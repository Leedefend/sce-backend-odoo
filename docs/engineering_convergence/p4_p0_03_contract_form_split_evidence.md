...
| File | Before | After |
| --- | ---: | ---: |
| `frontend/apps/web/src/pages/ContractFormPage.vue` | 13762 | 8860 |
...
- `ContractFormPage.vue` is line-count locked at 8860 lines. Future work must continue extracting or modifying existing owned modules instead of adding new responsibilities to the route component.
