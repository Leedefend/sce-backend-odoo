...
- Deploy runbook (zh): `docs/ops/runbook_deploy_zh.md`
- Reset & verify handbook: `docs/ops/reset_verify.md`
- Razor flow (noise-off init): `docs/ops/db_init_razor_flow.md`
- Odoo 17 baseline deploy: `docs/ops/DEPLOY_ODDO17_BASELINE.md`

## Verification and Scorecards
- P0 verification flow: `docs/ops/verify_p0.md`
- Init scorecard: `docs/ops/init_scorecard.md`
