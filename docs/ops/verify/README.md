...
- `make verify.release.v2_0_0.control_docs.guard`
  ...
  - Enforces release document list, release-notes tag plan and minimum verification commands, and promotion order shape for the v2.0.0 control README and versioning guide.
