...
- `make verify.release.v2_0_0.control_docs.guard`
  ...
  - Enforces release document list, release-control boundary and gate command blocks, rollback list, release-index planned entries, release-notes scope, tag plan, known limits, acceptance command blocks, and promotion order shape for the v2.0.0 control README and versioning guide.
