...
- Project dashboard contract guards:
...
- Plan contract guards:
  - `make verify.product.project_plan_entry_contract_guard`
  - `make verify.product.project_plan_block_contract_guard`
- Full chain pre-execution flow:
  - `make verify.product.project_flow.full_chain_pre_execution`
...
- Execution state transition guard:
  - `make verify.product.project_execution_state_transition_guard`
...
- Product v0.1 pilot execution review:
  - `make verify.product.v0_1_pilot_execution_review`
  - records the real pilot path step-by-step and emits feedback-ready evidence
...
- Coverage:
  ...
  - first-pilot execution review artifact frozen to `product_v0_1_pilot_execution_review`
...
- Execution order (hard):
  ...
  7. `verify.product.project_dashboard_baseline` (Product Dashboard Flow + Contract Guards)
