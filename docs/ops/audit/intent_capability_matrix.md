...
- missing_smoke_target_count: 59
- write_without_required_groups_count: 8
- write_without_acl_hint_count: 21
...
| search.favorite.set | domain | 1 | - | N | Y | N | Y | Y | Y | addons/smart_core/handlers/search_favorite_set.py |
