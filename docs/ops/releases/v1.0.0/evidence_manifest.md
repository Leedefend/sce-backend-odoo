# v1.0.0 Evidence Manifest

## Required Before `gate-release-v1.0`
...
| Evidence | Command | Required Result | Artifact |
|---|---|---|---|
| Release preflight | `make verify.release.v1_0_0.preflight` | PASS | aggregate terminal output |
...
## Required Product Hardening Before Formal `v1.0.0`

| Evidence | Command | Required Result | Artifact |
|---|---|---|---|
| Product release readiness | `make verify.release.v1_0_0.product_hardening` | PASS | `artifacts/backend/bundle_installation_report.json` and related product gate artifacts |
| Platform performance smoke | included in `make verify.release.v1_0_0.product_hardening` | PASS | `artifacts/backend/platform_performance_smoke.json` |
...
| Release checklist signoff | manual review | PASS | `docs/ops/release_checklist_v1.0.0.md` |
...
- Command: `make verify.release.v1_0_0.product_hardening`
...
- Note: before creating `gate-release-v1.0` or `v1.0.0-rc1`, rerun required
