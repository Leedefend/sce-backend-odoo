...
- `window_identity`: normalized object form `{window_id, query_fingerprint, window_digest, version, algo, key, window_start, window_end, group_offset, group_limit, group_count}`
