...
- 当前 payload 晋级队列：11 个 lane，按 foundation、用户权限、主数据、合同/供应商、收款、付款、财务、物资投标、附件流程、正式投影、runtime probe 顺序推进；JSON 固化完整 backlog 明细，全量守卫禁止 `unclassified` lane 并校验明细计数
