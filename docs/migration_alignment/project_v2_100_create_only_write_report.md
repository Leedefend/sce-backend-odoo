# Project v2 100-row create-only write report

## Scope

- Task: `ITER-2026-04-14-0009`
- Database: `sc_demo`
- Model: `project.project`
- Input: `artifacts/migration/project_next_100_candidate_v2.csv`
- Authorization packet: `artifacts/migration/project_v2_100_write_authorization_packet.json`
...
- Created Odoo IDs: 2237 through 2336

## Artifacts

- Pre-write snapshot: `artifacts/migration/project_v2_100_pre_write_snapshot.csv`
- Post-write snapshot: `artifacts/migration/project_v2_100_post_write_snapshot.csv`
- Write result: `artifacts/migration/project_v2_100_write_result.json`
...
- Immediate next step is a readonly post-write review and rollback-lock batch.
