# SCBS55 Delivery Replay Requirement Lock v1
...
- gap required input unique paths: `115`
- baseline excluded required paths: `4`
- delivery required replay artifacts: `111`
- release required replay artifacts: `111`
...
- `artifacts/migration/fresh_db_legacy_equipment_lease_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_legacy_equipment_lease_replay_payload_v1.csv`
...
- `artifacts/migration/fresh_db_legacy_fund_confirmation_header_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_legacy_fund_confirmation_header_replay_payload_v1.csv`
...
- `artifacts/migration/fresh_db_legacy_income_invoice_replay_adapter_result_v1.json`
...
- `artifacts/migration/fresh_db_legacy_labor_subcontract_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_legacy_labor_subcontract_replay_payload_v1.csv`
...
- `artifacts/migration/fresh_db_legacy_material_stock_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_legacy_material_stock_replay_payload_v1.csv`
...
- `artifacts/migration/fresh_db_legacy_workflow_audit_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_outflow_request_line_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_outflow_request_line_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_outflow_request_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_outflow_request_replay_payload_v1.csv`
...
- `artifacts/migration/fresh_db_project_member_neutral_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_receipt_counterparty_partner_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_receipt_counterparty_partner_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_receipt_invoice_attachment_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_receipt_invoice_attachment_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_receipt_invoice_line_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_receipt_invoice_line_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_receipt_write_design_payload_v1.csv`
- `artifacts/migration/fresh_db_replay_manifest_v1.json`
- `artifacts/migration/fresh_db_supplier_contract_line_replay_adapter_result_v1.json`
- `artifacts/migration/fresh_db_supplier_contract_line_replay_payload_v1.csv`
- `artifacts/migration/fresh_db_supplier_contract_replay_adapter_result_v1.json`
...
- `artifacts/migration/history_expense_deposit_partner_targeted_replay_payload_v1.csv`
...
- `artifacts/migration/history_project_member_attachment_targeted_replay_adapter_result_v1.json`
- `artifacts/migration/history_project_member_attachment_targeted_replay_payload_v1.csv`
- `artifacts/migration/history_receipt_income_partner_targeted_replay_payload_v1.csv`
- `artifacts/migration/history_supplier_partner_targeted_replay_payload_v1.csv`
- `artifacts/migration/project_member_neutral_34_write_result_v1.json`

## Decision

`delivery and release package gates must use this required replay artifact set; delivery audit reports may only replace this lock after package materialization`
