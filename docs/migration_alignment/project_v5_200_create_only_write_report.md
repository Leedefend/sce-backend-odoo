# Project v5 200-row create-only write report

## Scope

- Task: `ITER-2026-04-14-0021`
- Database: `sc_demo`
- Model: `project.project`
- Input: `artifacts/migration/project_next_200_candidate_v5.csv`
- Authorization packet: `artifacts/migration/project_v5_200_write_authorization_packet.json`
...
- Pre-write snapshot: `artifacts/migration/project_v5_200_pre_write_snapshot.csv`
- Post-write snapshot: `artifacts/migration/project_v5_200_post_write_snapshot.csv`
- Write result: `artifacts/migration/project_v5_200_write_result.json`
