...
|---|---|---|---|---|
| W1-01 | Lock `construction_pm_v1` main-nav allowlist | P1 | TODO | policy and runtime output are aligned |
| W1-02 | Publish nav-to-scene mapping | P1 | TODO | all 7 nav items are traceable |
