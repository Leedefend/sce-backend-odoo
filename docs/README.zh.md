...
## 角色入口
- 运维：`docs/ops/README.zh.md`
- 开发：`docs/dev/README.zh.md`
- 产品：`docs/product/feature_index.zh.md`
...
## 架构
- 架构索引：`docs/architecture/README.zh.md`

## 发布规划（SCEMS v1.0）
- 发布总蓝图：`docs/releases/construction_system_v1_release_plan.md`
...
- Phase 1 映射清单：`docs/releases/phase_1_navigation_scene_mapping.md`
- Phase 1 收口报告：`docs/releases/phase_1_navigation_convergence_report.md`
- Phase 2 清单：`docs/releases/phase_2_core_scenarios_closure_checklist.md`
- Phase 2 W1（7-block 契约验证）：`docs/releases/phase_2_w1_project_management_7block_verify_report.md`
