...
- database: `sc_demo`
- generated_at: `2026-07-01T14:31:16.219398+00:00`
...
- formal_center_inactive_history_count: `32`
...
- 智慧施工管理平台 [`formal_product`]
  ...
  - 物资与分包 [`formal_product`]
    ...
    - 劳务管理 [`formal_product`]
      ...
      - 劳务结算候选核对 [`history_acceptance` inactive] -> `sc.labor.settlement.candidate`
