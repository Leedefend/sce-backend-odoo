...
| B2 命名语义 | CW-P1-002、CW-P1-008、CW-P1-014、CW-P1-019、CW-P1-021、CW-P1-023、CW-P1-024 | 已完成首轮治理 | 默认界面只允许业务语言；配置对象不能被表达成业务办理动作，符号动作和恢复动作必须有可理解语义 |
| B3 操作闭环 | CW-P1-004、CW-P1-005、CW-P1-009、CW-P1-012、CW-P1-015、CW-P1-021、CW-P1-023、CW-P1-024 | 已完成首轮治理 | 所有子能力必须有一致的进入、返回、保存、预览路径 |
