...
| CW-P1-031 | P1 | 菜单配置页存在一批泛化辅助动作，如“刷新”“新增同级”“复制当前入口”“生效检查”“版本与回滚”，用户需要结合上下文猜测作用对象 | `07-menu-config.png` | 已批量修复：统一改为“刷新菜单配置”“新增同级菜单”“复制当前菜单入口”“检查菜单生效”“查看菜单版本与回滚”等对象化动作；门禁新增菜单动作标签批量断言 |
...
| 批次 | 已覆盖问题 | 当前状态 | 后续关注 |
| --- | --- | --- | --- |
| B1 信息架构 | CW-P1-001、CW-P1-006、CW-P1-011、CW-P1-020、CW-P1-022 | 已完成首轮治理 | 页面任务区、状态区、目录区不能互相抢职责；顶部范围动作不能重复配置任务动作；核心配置对象必须易读 |
| B2 命名语义 | CW-P1-002、CW-P1-008、CW-P1-014、CW-P1-019、CW-P1-021、CW-P1-023、CW-P1-024、CW-P1-025、CW-P1-026、CW-P1-027、CW-P1-028、CW-P1-029、CW-P1-030、CW-P1-031 | 已完成首轮治理 | 默认界面只允许业务语言；配置对象不能被表达成业务办理动作，符号动作和恢复动作必须有可理解语义 |
| B3 操作闭环 | CW-P1-004、CW-P1-005、CW-P1-009、CW-P1-012、CW-P1-015、CW-P1-021、CW-P1-023、CW-P1-024、CW-P1-025、CW-P1-026、CW-P1-027、CW-P1-028、CW-P1-029、CW-P1-030、CW-P1-031 | 已完成首轮治理 | 所有子能力必须有一致的进入、返回、保存、预览路径 |
| B4 编辑效率 | CW-P1-016、CW-P1-017、CW-P1-018 | 已完成首轮治理 | 表单字段、列表字段、审批步骤、菜单目录需要持续评估搜索、批量添加、数量反馈 |
| B5 响应式与视觉稳定 | CW-P1-007、CW-P1-010、CW-P1-022 | 已完成首轮治理 | 移动端必须以真实视口为准，不以 fullPage 截图代替；短业务标题不得拆字换行 |
