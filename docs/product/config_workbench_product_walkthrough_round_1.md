...
| 批次 | 已覆盖问题 | 当前状态 | 后续关注 |
| --- | --- | --- | --- |
| B1 信息架构 | CW-P1-001、CW-P1-006、CW-P1-011 | 已完成首轮治理 | 页面任务区、状态区、目录区不能互相抢职责 |
| B2 命名语义 | CW-P1-002、CW-P1-008、CW-P1-014 | 已完成首轮治理 | 默认界面只允许业务语言；配置对象不能被表达成业务办理动作 |
| B3 操作闭环 | CW-P1-004、CW-P1-005、CW-P1-009、CW-P1-012、CW-P1-015 | 已完成首轮治理 | 所有子能力必须有一致的进入、返回、保存、预览路径 |
| B4 编辑效率 | CW-P1-016、CW-P1-017 | 已启动首轮治理 | 表单字段、列表字段、审批步骤、菜单目录需要持续评估搜索、批量添加、数量反馈 |
| B5 响应式与视觉稳定 | CW-P1-007、CW-P1-010 | 已完成首轮治理 | 移动端必须以真实视口为准，不以 fullPage 截图代替 |
