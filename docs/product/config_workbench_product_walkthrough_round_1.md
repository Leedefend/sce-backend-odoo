...
| B3 操作闭环 | CW-P1-004、CW-P1-005、CW-P1-009、CW-P1-012、CW-P1-015、CW-P1-021、CW-P1-023、CW-P1-024、CW-P1-025、CW-P1-026、CW-P1-027、CW-P1-028、CW-P1-029、CW-P1-030、CW-P1-031、CW-P1-032、CW-P1-033、CW-P1-034 | 已完成首轮治理 | 所有子能力必须有一致的进入、返回、保存、预览路径；滚动时辅助栏不能遮挡主编辑区域 |
| B4 编辑效率 | CW-P1-016、CW-P1-017、CW-P1-018 | 已完成首轮治理 | 表单字段、列表字段、审批步骤、菜单目录需要持续评估搜索、批量添加、数量反馈 |
| B5 响应式与视觉稳定 | CW-P1-007、CW-P1-010、CW-P1-022、CW-P1-034 | 已完成首轮治理 | 移动端和桌面滚动都必须以真实视口和元素命中为准，不以 fullPage 截图代替；短业务标题不得拆字换行，辅助栏不得遮挡编辑区 |
