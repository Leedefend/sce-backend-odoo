...
- generated_at_utc: 2026-05-14T07:22:57Z
- branch: `feature/fix-list-create-button`
- commit_ref: `894050be`
...
| CI restricted profile readiness | PASS (2026-05-14T07:22:56Z) | `CI_SCENE_DELIVERY_PROFILE=restricted make ci.scene.delivery.readiness` |
...
5. CI profile posture: strict=UNKNOWN, restricted=PASS (2026-05-14T07:22:56Z); release execution should use strict in live-enabled runners and restricted only for network-restricted evidence runs.
