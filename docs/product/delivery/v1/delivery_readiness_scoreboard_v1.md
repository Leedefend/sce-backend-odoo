...
- generated_at_utc: 2026-05-12T15:03:00Z
- branch: `main`
- commit_ref: `e5db57a0`
...
| CI restricted profile readiness | PASS (2026-05-12T15:03:00Z) | `CI_SCENE_DELIVERY_PROFILE=restricted make ci.scene.delivery.readiness` |
...
5. CI profile posture: strict=UNKNOWN, restricted=PASS (2026-05-12T15:03:00Z); release execution should use strict in live-enabled runners and restricted only for network-restricted evidence runs.
