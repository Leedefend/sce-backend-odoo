...
- `python3 agent_ops/scripts/validate_task.py agent_ops/tasks/ITER-2026-04-01-596.yaml`: PASS
...
- PASS
- HUD route placeholder normalization is stable under strict typing and dedicated smoke
