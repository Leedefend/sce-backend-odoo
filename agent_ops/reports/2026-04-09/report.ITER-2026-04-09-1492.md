...
## Change summary
- 执行 1491（Form 关键动作入口交互锁守卫）后的阶段 parity 校验。
- 本批为 verify-only，无实现代码变更。

## Verification result
- `python3 agent_ops/scripts/validate_task.py agent_ops/tasks/ITER-2026-04-09-1492.yaml` ✅
...
## Next suggestion
- 继续下一 implement 切片，补齐 form 细节交互与原生对齐项。
