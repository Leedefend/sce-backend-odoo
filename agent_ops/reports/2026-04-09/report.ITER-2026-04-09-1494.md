...
## Change summary
- 执行 1493（form relation/one2many 交互门控）后的阶段 parity 校验。
- 本批为 verify-only，无实现代码变更。

## Verification result
- `python3 agent_ops/scripts/validate_task.py agent_ops/tasks/ITER-2026-04-09-1494.yaml` ✅
...
## Next suggestion
- 继续下一 implement 切片，聚焦 form 输入变更函数层门控一致性。
