...
- risk: medium
- publishability: ready_for_next_scene_template_slice

## Summary of Change

- updated:
  - `agent_ops/tasks/ITER-2026-04-05-1029.yaml`
  ...
  - `agent_ops/reports/2026-04-05/report.ITER-2026-04-05-1029.md`
  - `agent_ops/state/task_results/ITER-2026-04-05-1029.json`
  - `docs/ops/iterations/delivery_context_switch_log_v1.md`
- implementation:
  - moved `/api/scenes/export` route-shell ownership to smart_core.
  - preserved export behavior by delegating to existing scenario controller method.

## Verification Result

- `python3 agent_ops/scripts/validate_task.py agent_ops/tasks/ITER-2026-04-05-1029.yaml`: PASS
...
- medium: governance export route-shell moved; delegation preserves semantics.
...
- `git restore agent_ops/tasks/ITER-2026-04-05-1029.yaml`
- `git restore agent_ops/reports/2026-04-05/report.ITER-2026-04-05-1029.md`
- `git restore agent_ops/state/task_results/ITER-2026-04-05-1029.json`
- `git restore docs/ops/iterations/delivery_context_switch_log_v1.md`

## Decision

- PASS
- next stage suggestion: migrate `/api/scenes/import` in dedicated bounded write batch.
