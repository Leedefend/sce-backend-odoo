...
verify.business_config.unit: guard.prod.forbid verify.frontend.product_language.guard verify.business_config.product_guard
...
# ==================== Policy Ops ======================
# ======================================================
.PHONY: db.frontend.acceptance.ensure demo.frontend.fixture verify.frontend.fixture verify.frontend.fixture.guard verify.frontend.fixture.browser verify.frontend.navigation.access verify.frontend.page_identity.browser verify.frontend.page_identity.deep.browser verify.frontend.financial_workspace.guard verify.frontend.financial_workspace.runtime verify.frontend.financial_workspace.action verify.frontend.financial_workspace.v2_contract verify.frontend.financial_workspace.browser verify.frontend.core_record_form.audit verify.frontend.core_record_form.journeys verify.frontend.product_design_system.audit verify.frontend.page_width_contract.audit verify.frontend.workspace_content_alignment.audit verify.frontend.form_canvas_wide_grid.audit verify.frontend.my_work_approval.runtime verify.frontend.my_work_approval.browser verify.frontend.delivery_hardening.browser verify.frontend.shell_usability.browser policy.apply.business_full policy.apply.role_matrix policy.ensure.role_surface_demo smoke.business_full smoke.role_matrix verify.portal.role_surface_preflight.container verify.portal.role_surface_smoke.container p2.smoke p3.smoke p3.audit codex.preflight codex.merge codex.rollback codex.pr.body codex.release.note db.policy stage.preflight stage.run ops.auth.dev.apply ops.auth.dev.rollback ops.auth.dev.verify
...
verify.frontend.fixture.browser: guard.prod.forbid check-compose-project check-compose-env
	...
	$(MAKE) --no-print-directory backend.acceptance.up; $(MAKE) --no-print-directory frontend.acceptance.up; trap '$(MAKE) --no-print-directory frontend.acceptance.down; $(MAKE) --no-print-directory backend.acceptance.down' EXIT; $(RUN_ENV) DB_NAME=$(FRONTEND_ACCEPTANCE_DB) SC_ENVIRONMENT=acceptance SC_ALLOW_DEMO_DATA=1 FRONTEND_URL=$${FRONTEND_URL:-http://127.0.0.1:5175} FRONTEND_FIXTURE_PAYMENT_ACTION_ID=$${FRONTEND_FIXTURE_PAYMENT_ACTION_ID} FRONTEND_FIXTURE_PAYMENT_MENU_ID=$${FRONTEND_FIXTURE_PAYMENT_MENU_ID} FRONTEND_FIXTURE_PAYMENT_RECORD_A_ID=$${FRONTEND_FIXTURE_PAYMENT_RECORD_A_ID} FRONTEND_FIXTURE_PAYMENT_RECORD_C_ID=$${FRONTEND_FIXTURE_PAYMENT_RECORD_C_ID} node scripts/verify/frontend_productization_fixture_browser.mjs
